  ...
  return (
    <ProtectedRoute>
      <div className="flex min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <aside
          className={`fixed top-0 left-0 z-50 h-screen flex flex-col justify-between border-r border-border bg-sidebar text-sidebar-foreground py-4.5 pb-6 px-4
        ...
        >
          <div>
            ...
            >
              ...
              <button
                onClick={() => setSidebarOpen(false)}
                className="p-2.5 rounded-full bg-muted hover:bg-accent lg:hidden transition duration-300 cursor-pointer"
              >
            ...
            <nav className="flex flex-col gap-1 mb-8">
              {userRole === "user" && (
                <UserDashboard collapsed={sidebarCollapsed} />
              )}
              {userRole === "rider" && (
                <RiderDashboard collapsed={sidebarCollapsed} />
              )}
              {userRole === "admin" && (
                <AdminDashboard collapsed={sidebarCollapsed} />
              )}
            </nav>
          </div>
              ...
              >
                <svg
                  ...
                  className={`transition-all duration-500 ${
                    sidebarCollapsed ? "w-7 h-7" : "w-6 h-6 mr-2"
                  }`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                ...
                <span
                  className={`text-sm font-semibold transform transition-all duration-500 ${
                    sidebarCollapsed
                      ...
                      : "opacity-100 translate-x-0 ml-1 w-auto"
                  }`}
                >
                  Logout
                </span>
        ...
        <div className="flex-1 flex flex-col">
          <header
            className={`flex items-center justify-between px-6 py-3 border-b border-border bg-background text-foreground fixed top-0 w-full ${
              sidebarCollapsed
          ...
          >
            <div className="flex items-center gap-4">
              <button
                ...
                className="p-2.5 rounded-full bg-muted hover:bg-accent transition cursor-pointer"
              >
            ...
            <div className="flex items-center gap-3 md:gap-5">
              ...
              {data && (
                <Link
                  ...
                  className="flex items-center gap-3 p-1 rounded-full hover:bg-muted transition"
                >
