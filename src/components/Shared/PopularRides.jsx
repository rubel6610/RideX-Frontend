            ...
            <div className="  px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 ">
                    <Link href="/rides/bike" className="group">
                        <div className="card p-6 space-y-4 hover-lift shadow-md bg-[#6CC832]/5 rounded-2xl flex flex-col items-center transition-all duration-200 group-hover:bg-[#6CC832]/10 cursor-pointer border border-[#6CC832]/10">
